...
RDKIX_RDGENERAL_EXPORT extern const std::string _ringStereoOtherAtom;  // int
RDKIX_RDGENERAL_EXPORT extern const std::string _mesoOtherAtom;        // int
...
RDKIX_RDGENERAL_EXPORT extern const std::string molRingBondCount;   // int
...
RDKIX_RDGENERAL_EXPORT extern const std::string _fromAttachPoint;   // int
...
RDKIX_RDGENERAL_EXPORT extern const std::string _NonExplicit3DChirality;  // int
