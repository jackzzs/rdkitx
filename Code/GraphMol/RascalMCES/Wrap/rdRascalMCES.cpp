...
python::list bondMatches(const RDKix::RascalMCES::RascalResult &self) {
  return convertVecPairInt(self.getBondMatches());
}
python::list atomMatches(const RDKix::RascalMCES::RascalResult &self) {
  return convertVecPairInt(self.getAtomMatches());
}

void largestFragmentOnly(RDKix::RascalMCES::RascalResult &self) {
...
BOOST_PYTHON_MODULE(rdRascalMCES) {
  ...
  python::class_<RDKix::RascalMCES::RascalOptions, boost::noncopyable>(
      ...
      .def_readwrite(
          ...
          &RDKix::RascalMCES::RascalOptions::exactConnectionsMatch,
      ...
      .def_readwrite(
          "maxBondMatchPairs",
          &RDKix::RascalMCES::RascalOptions::maxBondMatchPairs,
      ...
      .def_readwrite("equivalentAtoms",
                     &RDKix::RascalMCES::RascalOptions::equivalentAtoms,
      ...
      .def_readwrite("ignoreBondOrders",
                     &RDKix::RascalMCES::RascalOptions::ignoreBondOrders,
