...
*/
RDKIX_GRAPHMOL_EXPORT std::pair<bool, bool> hasQueryHs(const ROMol &mol);
...
//! \overload
RDKIX_GRAPHMOL_EXPORT void cleanupAtropisomers(RWMol &);
//! removes bogus atropisomeric markers (e.g. those without sp2 begin and end
//! atoms):
RDKIX_GRAPHMOL_EXPORT void cleanupAtropisomers(RWMol &mol,
...
RDKIX_GRAPHMOL_EXPORT void clearAllBondDirFlags(ROMol &mol);
RDKIX_GRAPHMOL_EXPORT void clearDirFlags(ROMol &mol,
                                         bool onlyWedgeFlags = false);
...
/*!
  ...
  \return the AMW
*/
RDKIX_GRAPHMOL_EXPORT double getAvgMolWt(const ROMol &mol,
...
/*!
  ...
  \return the exact MW
*/
RDKIX_GRAPHMOL_EXPORT double getExactMolWt(const ROMol &mol,
                                           bool onlyHeavy = false);
...
*/
RDKIX_GRAPHMOL_EXPORT std::string getMolFormula(
 ...
 *
 */
RDKIX_GRAPHMOL_EXPORT void expandAttachmentPoints(RWMol &mol,
 ...
 *
 */
RDKIX_GRAPHMOL_EXPORT void collapseAttachmentPoints(RWMol &mol,
 ...
 *
 */
RDKIX_GRAPHMOL_EXPORT unsigned int addExplicitAttachmentPoint(
 ...
 *
 */
RDKIX_GRAPHMOL_EXPORT bool isAttachmentPoint(const Atom *atom,
                                             bool markedOnly = true);
